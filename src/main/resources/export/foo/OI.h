//This header file and cpp file will be generated to include all getters and button declerations that we do each year
//for a driver and a COdriver controller. It will not assign commands to button even though robotbuilder will seem to let
//you do that. Just a warning
#ifndef OI_H
\#define OI_H
